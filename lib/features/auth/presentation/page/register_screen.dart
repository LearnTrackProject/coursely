...
class _RegisterScreenState extends State<RegisterScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SafeArea(
        child: _BuildRegisterBody(isChecked, onCheckChanged, widget.userType),
      ),
    );
  }
...
class _BuildRegisterBody extends StatelessWidget {
  ...
  const _BuildRegisterBody(this.isChecked, this.onCheckChanged, this.userType);
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          MainButton(
                            text: 'Create Account',
                            onPressed: () async {
                              await cubit.register(userType: userType);
                            },
                          ),
                          Spacer(),
                          Padding(
