...
import 'package:coursely/core/helper/app_regex.dart';
    ...
    return BlocListener<AuthCubit, AuthState>(
      listener: (context, state) async {
        if (state is AuthSuccessState) {
          ...
          final role = currentUser?.photoURL;

          print("Firebase Role: $role");

          if (role == "student" && widget.userType == UserTypeEnum.student) {
            Navigation.pushReplacementNamed(context, Routes.mainScreen);
          } else if (role == "instructor" &&
              widget.userType == UserTypeEnum.teacher) {
            Navigation.pushReplacementNamed(context, Routes.instructorScreen);
          } else {
            ScaffoldMessenger.of(context).showSnackBar(
              const SnackBar(content: Text("Invalid user type or mismatch")),
            );
          }
          // Navigation.pop(context);
          // if (cubit.userKind == "student" &&
          //     widget.userType == UserTypeEnum.student) {
          //   Navigation.pushNamedTo(context, Routes.instructorScreen);
